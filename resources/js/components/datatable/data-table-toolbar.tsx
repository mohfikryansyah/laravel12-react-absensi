...
export function DataTableToolbar<TData>({ table, children, columnFilter, titleFilter, optionsFilter }: DataTableToolbarProps<TData>) {
    ...
    return (
        <div className="flex items-center justify-between">
          ...
          className="h-8 w-[150px] lg:w-[250px]"
        /> */}
                {columnFilter && optionsFilter && table.getColumn(columnFilter) && <DataTableFacetedFilter column={table.getColumn(columnFilter)} title={titleFilter} options={optionsFilter} />}
                {isFiltered && (
